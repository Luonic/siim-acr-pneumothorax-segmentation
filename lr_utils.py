...
class CyclicalLR():
    def __init__(self, max_lr, base_lr, steps_per_epoch, epochs_per_cycle, mode='cosine'):
        self.base_lr = max_lr
        self.min_lr = base_lr
        self.mode = mode
        self.lr_delta = max_lr - base_lr
        self.steps_per_cycle = steps_per_epoch * epochs_per_cycle
        self.step_value = 0
    ...
    def get_new_lr(self):
        return self.lr_mult_fn() * self.lr_delta + self.min_lr
...
class LRFinder(object):
    ...
    def __init__(self, model, optimizer, criterion, device=None, memory_cache=True, cache_dir=None,
                 input_extraction_fn=None, target_extraction_fn=None):
        self.model = model
        ...
        self.input_extraction_fn = input_extraction_fn
        self.label_extraction_fn = target_extraction_fn
    ...
    def _train_batch(self, inputs, labels):
        ...
        # Extract from data structures
        if self.input_extraction_fn:
            inputs = self.input_extraction_fn(inputs)

        if self.label_extraction_fn:
            labels = self.label_extraction_fn(labels)
